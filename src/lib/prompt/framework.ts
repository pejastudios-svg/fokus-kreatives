...
- Use a clipped fragment as dramatic setup before the real line. The tell is the two-beat cadence: a 2-4 word fragment, a full stop, then the payload. Examples of the tell: "Watch one die. I made content, and then...", "Same story, alive. I made content, but...", "Now the reveal.", "Here comes the fun part.", "Enter the fix." A real person opens with a full sentence the listener understands in one second: "Read this out loud.", "Check this out.", "Now watch what happens." THIS APPLIES TO CAROUSEL SLIDES AND CAPTIONS TOO, not only spoken lines. Test: if a reader needs more than a second to work out what the fragment means, it does not make sense - rewrite it.
- Use the "Same X, different Y" construction ("Same events, different engine.", "Same story, different day.", "Same words, different order."). It is a fragment pretending to be a conclusion, and it is one of the strongest AI tells in written captions. Write the actual sentence instead: "I didn't change a single event in that story, I only changed the words holding the lines together."
...
- Use colon-led labels ANYWHERE in spoken lines or captions. The pattern is a short noun-phrase label, a colon, then the payoff - in ANY wording: "What I learned: ...", "Here's why: ...", "The takeaway: ...", "The real issue: ...", "The fix: ...", "The real key: ...", "My mistake: ...", "My process: ...", "The problem: ...", "The shift: ...". Write the full sentence instead: not "The real issue: your content has no anchor" but "The real issue is that your content has no anchor"; not "The fix: build a system" but "The fix is to build a system". A colon that introduces a list of items or a verbatim quote is fine - the ban is the label-then-payoff fragment.
