...
export async function GET(req: NextRequest) {
  try {
    ...
    const { data: storyRows } = await supabase
      ...
      .select('id, format_id, source_format_id, carrier, intent, campaign, mechanic, prompt_text, visual_direction, frames, who_films, raw_material_refs, pinned_to_date, seed_text, created_at, consumed_at')
      .eq('client_id', clientId)
      .is('consumed_at', null)
